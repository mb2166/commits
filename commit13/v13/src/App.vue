...
export default {
  ...
  mounted() {
    //uncomment to clear all details in respective stores
      //localStorage.removeItem("Users"); //registered users storage
      //localStorage.removeItem("AuthUser");  //authentication session storage
      //localStorage.removeItem("ClassActivity"); // class/ activity details
      //localStorage.removeItem("ClassActivityRatings"); //class ratings
    //The abobe must be commented//
